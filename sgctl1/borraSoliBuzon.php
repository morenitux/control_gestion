...
<form name="borra_documento_buzon" method="post" action="insertRechazoDeBuzonDocumento.php?sess=<? echo $sess; ?>&control_botones_superior=1&accion=borrar&control=<? echo $control; ?>" target="_self" onsubmit="return regform_Validator(this);" onLoad="javascript: document.plantilla_documento.fec_recep.focus(); document.plantilla_documento.fec_recep.select();">
