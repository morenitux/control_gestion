	...
	if ($numero_renglones > 0) {
		...
		<table width=100% border=0 cellspacing=2 cellpadding=2>
		 <tr>
		  <td width=100% align=center>
				<font class='bigsubtitle'>Buz�n de solicitudes</font>
		  </td>
		 </tr>
		</table>
		<table width=100% border=0 cellspacing=2 cellpadding=2>
		...
		while($sql->next_record()) {
			...
			if (substr($control_menu_superior,1,1)!="2" && (!$folio_en_documentos)) {
				echo "<a href='principal.php?sess=$sess&control_botones_superior=8&variable=insertDocumentoDeBuzonDirecto&parametro=$parametro'><img src='$default->scg_graphics_url/registrar.gif' border='0' title='Recibir directamente el env�o' alt='Recibir directamente el env�o'></a>";
				echo "<a href='principal.php?sess=$sess&control_botones_superior=8&variable=rechazaSoliBuzon&parametro=$parametro''><img src='$default->scg_graphics_url/rechazar.gif' border='0' title='Contestar que el documento no compete' alt='Contestar que el documento no compete'></a>&nbsp;";
				echo "<a href='principal.php?sess=$sess&control_botones_superior=8&variable=recibeSoliBuzon&parametro=$parametro'><img src='$default->scg_graphics_url/cambio.gif' border='0' title='Complementar y Aceptar Env�o' alt='Complementar y Aceptar Env�o'></a>&nbsp;";
				echo "<a href='principal.php?sess=$sess&control_botones_superior=8&variable=borraSoliBuzon&parametro=$parametro&control=0'><img src='$default->scg_graphics_url/baja.gif' border='0' title='Eliminar registro' alt='Eliminar registro'></a>&nbsp;";
			} else {
				if ($folio_en_documentos) {
					...
					echo "<a href='principal.php?sess=$sess&control_botones_superior=8&variable=borraSoliBuzon&parametro=$parametro&control=1'><img src='$default->scg_graphics_url/baja.gif' border='0' title='Eliminar registro' alt='Eliminar registro'></a>&nbsp;";
				}
			}
			echo "\t</td>\n";
