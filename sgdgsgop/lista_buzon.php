	...
	if ($numero_renglones > 0) {
		...
		while($sql->next_record()) {
			...
			if (substr($control_menu_superior,1,1)!="2" && (!$folio_en_documentos)) {
				echo "<a href='principal.php?sess=$sess&control_botones_superior=8&variable=insertDocumentoDeBuzonDirecto&parametro=$parametro'><img src='$default->scg_graphics_url/registrar.gif' border='0' title='Recibir directamente el envío' alt='Recibir directamente el envío'></a>";
				...
				echo "<a href='principal.php?sess=$sess&control_botones_superior=8&variable=recibeSoliBuzon&parametro=$parametro'><img src='$default->scg_graphics_url/cambio.gif' border='0' title='Complementar y Aceptar Envío' alt='Complementar y Aceptar Envío'></a>&nbsp;";
