...
<td align="left" width="192">
   <?php echo "<img src='$default->scg_graphics_url/logometro.jpg' border=0 width=\"192\" height=\"47\">"; ?>
</td>
<td align="center">
    <font face="Arial" size="3"><b><i>Turno de Correspondencia</i></b></font>
</td>
<td align="right" width="170">
   <?php echo "<img src='$default->scg_graphics_url/sdgoperacion.jpg' border=0 width=\"170\" height=\"43\">"; ?>
</td>
</tr>
</table>
<br>
	  ...
	  <td width="75%" align="left" valign="top">
		  ...
		  switch ($cve_urge) {
			     ...
			     case 'U':
			          ...
			          break;
			     case 'E':
				      echo '&nbsp;Requiere respuesta extra urgente';
			          break;
		         }
		  ?>
		  </b></font>
...
if ($num > 0) {
   ...
   <table width="100%" border="0" cellspacing="<? echo $espaciado+1; ?>" cellpadding="<? echo $espaciado+1; ?>">
          <tr>
              <td width="5%" valign="top"><font face="Arial" size="3">C.c.c.e.p.:</font></td>
