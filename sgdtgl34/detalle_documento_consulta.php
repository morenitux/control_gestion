	...
	<table width="100%" border="0" cellspacing="<?php echo $espaciado; ?>" cellpadding="<?php echo $espaciado; ?>">
		<tr>
		 ...
		 <td width="88%" valign="<?php echo $alineacion_vertical; ?>" align="left">
		  <font class="chiquitoazul"><b>
			<?php
			//echo "<br>select nom_prom,cve_prom from promotor where tipo in ('R','Q') and cve_prom='$cve_remite'</br>";
	  ...
	  <tr>
	   ...
	   <td colspan=7>
		...
		for ($y=0; $y<$total_de_copias; $y++) {
			$buscando=$copia[$y];
			$sql2 = new scg_DB;
			$sql2->query("select nom_depe,cve_depe from dependencia where cve_depe='$buscando'");
