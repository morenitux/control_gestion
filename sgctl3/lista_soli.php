	...
	if ($numero_renglones > 0) {
		...
		while($sql->next_record()) {
			...
			if (substr($control_menu_superior,1,1)!="2" && (!$folio_en_documentos)) {
				echo "<a href='principal.php?sess=$sess&control_botones_superior=7&variable=insertDocumentoDeBuzonDirecto&parametro=$parametro'><img src='$default->scg_graphics_url/registrar.gif' border='0' title='Recibir directamente el env�o' alt='Recibir directamente el env�o'></a>";
				...
				//echo "<a href='principal.php?sess=$sess&control_botones_superior=7&variable=recibeSoliBuzon&parametro=$parametro'><img src='$default->scg_graphics_url/cambio.gif' border='0' title='Complementar y Aceptar Env�o' alt='Complementar y Aceptar Env�o'></a>&nbsp;";
