...
if ($en_catalogo>0) {
	$resulta = $sql->query("UPDATE expediente set nom_expe='$nom_expe' where cve_expe='$cve_expe'");
	if (!$resulta) {
	...
	printf("<br>El expediente que intenta actualizar ya no existe.<br> Por favor revise la clave que capturó.");
	printf("<br><br><input type='button' value='Regresar' onClick='javascript: history.go(-1);'>");
}
print("<br></center>\n<br>\n");
?>