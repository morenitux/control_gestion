...
switch ($tipo_reporte) {
	case "1": //Por turnados a:
		...
		$query.=" GROUP BY Dependencia.Nom_Depe,Docsal.Cve_Depe,Dependencia.Siglas";
	break;
	case "2": //Por fecha de compromiso
		...
		$query.=" GROUP BY Date_Part('month',Docsal.Fec_Comp)";
	break;
	...
	case "4": //Por año
		...
		$query.=" GROUP BY Date_Part('year',Docsal.Fec_salid)";
	break;
	case "5": //Por mes del año actual
		...
		$query.=" GROUP BY Date_Part('month',Docsal.Fec_salid)";
	break;
	case "6": //Turnos del día
...
if ($numero_renglones > 0) {
	...
	<table width=100% border=0 cellspacing=2 cellpadding=2>
		<tr bgcolor='#<? echo $bgcolor_titulos; ?>'>
			...
			<td align='center' class='chiquitoblanco'>
				<? echo "<a href='graficos.php?sess=$sess&control_botones_superior=$control_botones_superior&tipo_reporte=$tipo_reporte&columna=5'><font class='chiquitoblanco'>En trámite</font></a>"; ?>
			</td>
			<td align='center' class='chiquitoblanco'>
