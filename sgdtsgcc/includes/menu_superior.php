  ...
  <td width=60% align=center>
   ...
   if (substr($control_menu_superior,7,1)=="1") {
	   	if ($control_botones_superior!="7") {
	   		...
	   		echo "<a href='principal.php?sess=$sess&control_botones_superior=$nuevo_control_botones_superior'><img src='$default->scg_graphics_url/$soligif' border=0 alt='Buzón de solicitudes'></a>&nbsp;";
   		} else {
				echo "<a href='principal.php?sess=$sess&control_botones_superior=7'><img src='$default->scg_graphics_url/$soligif' border=0 alt='Buzón de solicitudes'></a>&nbsp;";
	   		//echo "<font class='chiquito'><img src='$default->scg_graphics_url/b61.gif' border=0 alt='Seguimiento de Turnos'>&nbsp;</font>";
	    }
   }
   ...
   if (substr($control_menu_superior,8,1)=="1") {
	   	if ($control_botones_superior!="8") {
	   		...
	   		echo "<a href='principal.php?sess=$sess&control_botones_superior=$nuevo_control_botones_superior'><img src='$default->scg_graphics_url/$respgif' border=0 alt='Buzón de respuestas'></a>&nbsp;";
   		} else {
				echo "<a href='principal.php?sess=$sess&control_botones_superior=8'><img src='$default->scg_graphics_url/$respgif' border=0 alt='Buzón de respuestas'></a>&nbsp;";
	   		//echo "<font class='chiquito'><img src='$default->scg_graphics_url/b61.gif' border=0 alt='Seguimiento de Turnos'>&nbsp;</font>";
	    }
   }
   //BOTON 9 IMPRESION
