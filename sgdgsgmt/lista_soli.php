...
if ($cuantos>0) {
	$query="SELECT fec_salid,fol_orig,conse,to_char(fec_salid,'dd/mm/yyyy') as fec_salid2,to_char(fec_comp,'dd/mm/yyyy') as fec_comp,'**-'||remite as remite,cve_urge,sintesis,cve_docto,to_char(fec_elab,'dd/mm/yyyy') as fec_elab,base_datos,prop_base from soli_buzon where soli_buzon.fol_orig is not null ";
