...
<td align="right" width="170">
   <?php echo "<img src='$default->scg_graphics_url/leyenda_dt.jpg' border=0 width=\"170\" height=\"43\">"; ?>
</td>
</tr>
</table>
<br>
...
<br>
   ...
   <table width="100%" border="0" cellspacing="<? echo $espaciado+1; ?>" cellpadding="<? echo $espaciado+1; ?>">
          <tr>
              <td width="5%" valign="top"><font face="Arial" size="1">Cccep:</font></td>
	          <td width="95%" align="left" valign="top">
	  <?
		//Sacar los nombres del campo nom_ccp y meter en arreglo.
		
		$sql = new scg_DB;
		$sql->query("select * from salccp where fol_orig='$fol_orig' and conse='$conse' order by conse");
		//echo "select * from salccp where fol_orig='$fol_orig' and conse='$conse' order by conse"; 
		$num = $sql->num_rows($sql);
		if ($num > 0) {
		  $texto="";
		  $nombres = array();
		  ...
		  //}
		    while ($sql->next_record()) {
				...
				$letra=$nom_ccp;
				//echo $letra;
				$letra= str_replace("][000", " <br> ", $letra);
				$letra= str_replace("[000","", $letra);
				$letra= str_replace("]","", $letra);

				echo '<font size=2>'.$letra.'</font>';
		...
		for ($i = 0; $i < count($nombres); $i++){
			//echo $nombres[i] .".- ". $cargos[i];
		}
		
		//echo $nombres[0] .".- ". $cargos[0];
		


	  ?>
              <font class="chiquito"><font face="Arial" size="1"><b><?php echo "$texto"; ?></b></font></font></td>
          </tr>
   </table>
</center>
</body>
