...
if ($en_catalogo>0) {
		$query="UPDATE turnador set nom_turn='$nom_turn',car_turn='$car_turn',no_oficio='$no_oficio' where cve_turn='$id'";
	...
	printf("<br>El turnador que intenta actualizar ya no existe.<br> Por favor revise los datos que capturó.");
