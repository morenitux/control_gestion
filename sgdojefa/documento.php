...
function regform_Validator(f) {
	if (f.cual_submit.value=="GUARDAR") {
		...
		if (f.cve_docto.value.length < 1) {
			alert("El n&uacutemero del documento no debe ser nulo \n(Escriba S/N cuando el documento no tenga n&uacutemero)");
			f.cve_docto.focus();
			return(false);
		}
	  ...
	  <td width="25%" valign="<?php echo $alineacion_vertical; ?>" align="right"
	   <?
		if ($iovar==1) {
			...
			echo "<font class='chiquito'>N&uacutemero de Entrada:</font>";
		} else {
	...
	<table width="100%" border="0" cellspacing="<? echo $espaciado; ?>" cellpadding="<? echo $espaciado; ?>">
	 <tr>
	  ...
	  <td width="15%" valign="<?php echo $alineacion_vertical; ?>" align="right"
		...
		?>
		<font class="chiquito">Elaboraci&oacuten:</font>
	  </td>
	  <td width="35%" valign="<?php echo $alineacion_vertical; ?>" align="left">
	  ...
	  <select name="cve_dirigido">
	   <option value=0 selected>
	   	...
	   	switch ($iovar) {
	   	  	...
	   	  	break;
	   	  	case 2:
				echo "Seleccione el �rea remitente ---------------------";
	   	  	break;
	   	}
		?>
	   </option>
	   <?php
	   		$sql = new scg_DB;
			$sql->query("select nombre,clave from dirigido where baja is null order by nombre,clave");
 ...
 <tr>
  <td width="100%" valign="top" align="center">
   <table width="100%" border="0" cellspacing="<? echo $espaciado; ?>" cellpadding="<? echo $espaciado; ?>">
	<tr>
	 <td width="40%" valign="<?php echo $alineacion_vertical; ?>" align="left">
	   <a href="javascript: newWindow('admin/admonCatalogo.php?sess=<? echo $sess; ?>&control_catalogos=3&origen=documento',600,400,'Principal','control_catalogos','ventana_auxiliar');"><font class="chiquito">Clasificaci&oacuten:</font></a><br><font size=-1>(ctrl + mouse para selecci&oacuten m&uacuteltiple)</font><br>
	 ...
	 <td width="60%" valign="<?php echo $alineacion_vertical; ?>" align="left"
		...
		?>
	   <font class="chiquito">Asunto:</font><br><font size=-1>(s&iacutentesis)</font><br>
